...
import ua.edu.ucu.apps.lab8_2.model.decorators.PaperDecorator;
import ua.edu.ucu.apps.lab8_2.model.decorators.RibbonDecorator;
import ua.edu.ucu.apps.lab8_2.model.decorators.BasketDecorator;
...
class DecoratorTest {
    ...
    void testPaperDecoratorPrice() {
        ...
        assertEquals(113.0, decoratedItem.price(), "Price should be base price plus 13");
    }
    ...
    void testBasketDecoratorPrice() {
        ...
        assertEquals(104.0, decoratedItem.price(), "Price should be base price plus 4");
    }
    ...
    void testRibbonDecoratorPrice() {
        ...
        assertEquals(140.0, decoratedItem.price(), "Price should be base price plus 40");
    }
    ...
    void testMultipleDecoratorsPrice() {
        ...
        assertEquals(157.0, decoratedItem.price(), "Price should include all decorations: 100 + 13 + 4 + 40");
    }
    ...
    void testNestedDecoratorsPrice() {
        ...
        assertEquals(126.0, decoratedItem.price(), "Price should reflect two layers of PaperDecorator");
    }
    ...
    void testDecoratorWithNoDecorations() {
        assertEquals(100.0, basicItem.price(), "Basic item price should be 100.0");
